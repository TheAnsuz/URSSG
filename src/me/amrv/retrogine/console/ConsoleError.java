...
public final class ConsoleError extends PrintStream {

	private final Console console;
	private final StringBuilder stream;

	protected ConsoleError(Console console) {
		super(new ConsoleNullErrorStream());
...
class ConsoleNullErrorStream extends OutputStream {
